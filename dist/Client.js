...
var Client = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _a = Error;
                        _b = "Request failed: " + response.status + " ";
                        return [4 /*yield*/, response.text()];
                    case 3: throw _a.apply(void 0, [_b + (_c.sent())]);
                }
            });
        });
    };
    Client.prototype.get = function (path, queryString) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
    ...
    Client.prototype.delete = function (path, queryString) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Client.prototype.post = function (path, _a) {
        var _b = _a === void 0 ? {} : _a, body = _b.body, queryString = _b.queryString;
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_c) {
                switch (_c.label) {
